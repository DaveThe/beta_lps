...
include_once(dirname(__FILE__).'/class_upload.php');
include_once(dirname(__FILE__).'/ManipulateImageByImageMagick.php');
?>
...
echo '<br>----'.$upload_dir.$fileName.' ---- <br>';
					...
					$arResultManImage   = $mni->manageImageMagik(
                                                                    ...
                                                                    true,
                                                                    array(
                                                                        0=>array("name"=>"medium","width_thumb"=>200,"height_thumb"=>'',"path"=>"class/MagicUpload/core/class"),
                                                                        1=>array("name"=>"small","width_thumb"=>64,"height_thumb"=>30,"path"=>"class/MagicUpload/core/class"),
                                                                        2=>array("name"=>"small_large","width_thumb"=>200,"height_thumb"=>50,"path"=>"class/MagicUpload/core/class"),
                                                                    ),
                                                                    false
                                                                );
