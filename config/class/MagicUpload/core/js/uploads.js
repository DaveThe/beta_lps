					...
					if(objJson.image.result_thumb)
					{
                        ...
                        if(opts.list)
                        {
                            ...
                            else
                            {
                                ...
                                $( "#"+div_img_id+"_list_group" ).append( '<input type="hidden" name="'+preview_list[div_img_id].id_img+'[]" id="img" value="'+objJson.filename.replace("del/", "")+'" />' ); 
