  ...
  <?php if(sizeof($errors)>0) $err = true; ?>
    ...
    <div class="box-edit-photo">
        ...
        <form method="post" action="profile_edit.php"> <!--/user/<?php echo($lapsic_user->id); ?>/edit">-->
            ...
            <?php /*<div class="MKU_AVATARS" id="avatar"><input type="hidden" id="source_name" value="<?php echo (isset($lapsic_user->img) ? $lapsic_user->img : ''); ?>" /></div> */ ?>
            <div class="box-txt-edit-photo">
                <div class="img-profilo-modifica">
                    <div class="MKU_UPDND" id="avatar"><input type="hidden" id="source_name" value="<?php echo (isset($lapsic_user->img) ? $lapsic_user->img : ''); ?>" /></div>
                </div>
            </div>
