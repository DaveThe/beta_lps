...
<div id="footer">
    <div class="footer-int">
        Lapsic.it 2015 &reg; - BETA -
        <div class="term-conditions">
            <?php /*<g:plusone size="small"></g:plusone>*/ ?> | <a href="http://lapsic.it/include/terms.php" id="popup_term">terms and conditions</a> | <a href="/about.php" id="popup_term">About</a><?php if(isset($_SESSION['lapsic_login']) && $_SESSION['lapsic_login']==true) { ?><a href="/index.php?exit=1"> | logout</a> <?php } ?>
        </div>
    </div>
</div>
