...
<?php 
/*
Per quanto riguarda il funzionamento, nella classe social c'è la funzione shareFB(ref), passagli l'url della pagina snapshot con url_encode(url) dal bottone che vuoi usare per fare il condividi e sei a posto
