...
?>
        ...
        <!-- POPUP -->
        <ul class="popup" style="display:none;">
  				<li class="popup-errore">
          	Attenzione non sei loggato!
          </li>
    ...
    <?php } else { ?>
        ...
        <div class="box-abs-what-and-time">
        	<ul>
          	<li <?php echo ((isset($mode) && $mode == 'new' && PAGE_NAME == 'INDEX') ? 'style ="background-color:#5F9CCA;"' : '') ?>> <a href="index.php?mode=new" class="nounderline">what's new</a></li>
          	<li <?php echo ((isset($mode) && $mode == 'timers' && PAGE_NAME == 'INDEX') ? 'style ="background-color:#5F9CCA;"' : '') ?>> <a href="index.php?mode=timers" class="nounderline">timing's best</a></li>
          </ul>
        </div>
        ...
        <?php } ?>
      	<div class="spacer-slider-blocchi-profile">
            ...
            <li <?php echo ( (PAGE_NAME == 'PROFILE' ) ? 'style ="background-color:#5F9CCA;"' : '') ?>>
              <a href="profile.php?id=<?php echo($lapsic_user->id); ?>" class="nounderline">your account</a>
            </li>
