...
function printItems($elements)
{
    ...
    ?>
        <div class="item" style="width: <?php echo ($dimensions['width']); ?>px;height: <?php echo ($dimensions['height']); ?>px;">
            <img class="img-zoom lazy" data-src="<?php echo $dimensions['name'] ?>" border="0" alt="" width="<?php echo ($dimensions['width']); ?>" height="<?php echo ($dimensions['height']); ?>" style="background-color: #<?php echo ($el['average_colour']); ?>;" />                            
