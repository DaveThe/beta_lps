...
class ManipulateImageByImageMagick {
	...
	*/
    ...
    {
		$result               = false;
		$orig_width_resize    = ($widthResize > $min_width) ? $widthResize : $min_width ;
		$orig_height_resize   = ($heightResize > $min_height) ? $heightResize : $min_height;
		...
		try 
        {
            ...
            */            
            ...
            if($mode == 'thumb')
            {
                //$dimension_thumb = ((floor($heightResize)>$min_height)?($widthResize.'x'.floor($heightResize)):($widthResize.'x'.$min_height));
                ...
                if(false) echo 'CHECK DIM- ORIG +'.$orig_height_resize.'+ --'.floor($heightResize).' > '.$min_height;
                ...
                {                     
                    ...
                    if(floor($heightResize)>$min_height)
                    {
                        ...
                        if(false) echo 'altezza più GRANDE quindi ok---'.   ($widthResize.'x'.floor($heightResize));
                    }
                    else
                    {
                        $dimension_thumb = ($widthResize.'x'.$min_height);
                        if(false) echo 'altezza PICCOLA quindi sistemo---'.   ($widthResize.'x'.$min_height);
                    }
                }
                else
                {
                    $dimension_thumb = ($widthResize.'x'.floor($heightResize));
                    if(false) echo 'altezza STABILITA quindi ok---'.   ($widthResize.'x'.floor($heightResize));
                }
