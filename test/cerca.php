 ...
 <div class="content-cerca">
  ...
  <div class="contenitore-box-cerca">
      ...
      <div class="input-cerca">
        <input type="text" id="search_text" value="lorem ipsum dolor sit amet lorem ipsum dolor sit amet" />
      </div>
      ...
      <div class="content-utente-cerca">
        <div id="user_search" class="box-utente-cerca" style="display: block;">
        <!-- STESSA GRAFICA ISOTOPE INDEX E ALTRE PAGINE PER GLI UTENT -->
        </div>
        <div id="photo_search" class="box-utente-cerca" style="display: none;">
        <!-- STESSA GRAFICA ISOTOPE INDEX E ALTRE PAGINE PER LE FOTO -->
        </div>
      </div>
