<?php /* PLUGIN UPLOAD */ ?>
        <?php /* <script src="<?php echo(JAVA_PLUGIN_PATH.'MagicUpload/core/js/upload.js'); ?>" type="text/javascript"></script> */ ?>
...
var preview_list = '';
        ...
        <script src="<?php echo(JAVA_PLUGIN_PATH.'MagicUpload/core/js/template.js'); ?>"></script>
        <script src="<?php echo(JAVA_PLUGIN_PATH.'MagicUpload/core/js/lang.js'); ?>"></script>
        <script src="<?php echo(JAVA_PLUGIN_PATH.'MagicUpload/core/js/uploads.js'); ?>"></script>
        <link href="<?php echo(JAVA_PLUGIN_PATH.'MagicUpload/core/css/upload.css'); ?>" rel="stylesheet" type="text/css" />
<script type="text/javascript">
$(document).ready(function(){ 
    $(document).MagicUpload({
                        	  ...
                        	  list                  : false, // visualizzare lista file caricati
