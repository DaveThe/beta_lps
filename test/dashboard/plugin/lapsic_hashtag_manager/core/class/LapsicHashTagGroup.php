...
class LapsicHashTagGroup extends OriginAbstract 
{
	...
	*/
	...
	/**
	* Parametro che indica il valore
	*
	* @var string
	*/
    public $value 		    = NULL;
	...
	*/
	...
	public function GetElement($id) 
    {
		...
		if ( isset($id) && ($id != '') ) {
            ...
            $operation->from(  array('S' => PREFIX.'lapsic_hashtag_group'),
                            array(  
                                    'id',
                                    'value',
                                    'description',
	 ...
	 */	
	 public function update()
	 {
        ...
        $sql = new Sql($this->db);
		$operation = $sql->update(PREFIX.'lapsic_hashtag_group');
		$newData = array(                            
    ...
    {		
        ...
        $sql = new Sql($this->db);        
        $operation = $sql->insert(PREFIX.'lapsic_hashtag_group');
        $newData = array(                                               
                            'value'         => isset($this->value) ? $this->value : 'NULL',
                            'description'   => isset($this->description) ? $this->description : 'NULL',
                            'created_by'    => isset($this->created_by) ? $this->created_by : 'NULL',
    ...
    {	
        return self::DeleteMaster($db, 'lapsic_hashtag_group', 'id', $id);
	}
    ...
    {	   
        return self::ApproveMaster($db, 'lapsic_hashtag_group', $id);
	}
    ...
    {	   
		return self::DisapproveMaster($db, 'lapsic_hashtag_group', $id);
	}
