...
$elements 			= LapsicHashTagGroup::GetElementsList($ParametersList);
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
											...
											<td style="line-height: 45px;"><?php echo ( ( ($WRITE) ? '<a href="plugs.php?plug='.$_plug.'&p_page=EditGroup.php&id_group='.$el['id'].'" ><span class=" iconia glyphicon glyphicon-pencil"></span></a>' : '') ); ?></td>
