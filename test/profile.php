  ...
  <div class="content-profilo">
    ...
    <div class="dettaglio-profilo-left">
        ...
        <div class="box-descrizione-profilo">
            ...
            <ul><li class="descr-txt">Description ></li> <li class="risultato-txt"> <?php echo (($element->note != '')?trim($element->note):'nothing here at the moment!'); ?></li></ul>
          ...
          <?php if($my_profile) { ?> <ul><li class="descr-txt"><a class="nounderline" href="profile_edit.php">edit > </a></li></ul> <?php } ?>
        </div>
    </div>
