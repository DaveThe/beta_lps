...
$(document).ready(function(){
		$grid = $('.iso-container');
        $grid.isotope({
    			itemSelector:<?php echo ((PAGE_NAME == 'PROFILE') ? "modeClass" : "'.item'"  )?>,
    			layoutMode:'masonry',
    			transformsEnabled: false,
    			//animationEngine: 'jquery',modeMasonry
    			masonry:{columnWidth:<?php echo ((PAGE_NAME == 'PROFILE') ? "modeMasonry" : "200"  )?>, gutter:15}
    	 });
    });
    ...
    {     
        $('[data-countdown]').each(function() {
            ...
            console.log(dataUtc);
            */
            var $this = $(this), finalDate = dataUtc; //$(this).data('countdown');
