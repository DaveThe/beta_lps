        ...
        <div class="box-dettaglio-profilo">
            <div class="box-numeri-profilo">
                <div class="numeri-profilo-left">
                    ...
                    <p class="time-profilo-dett"><a class="nounderline" href="/user/<?php echo($element->id); ?>/timing">Timing</a></p>
                    <p class="time-profilo-dett"><a class="nounderline"  href="/user/<?php echo($element->id); ?>/timers">Timers</a></p>
                </div> 
                <div class="numeri-profilo-right">
                    <p class="codice-utente">
                    <a href="/ranking" class="nounderline">
                    #<?php echo ($element->rank); ?>
                    </a>
                    </p>
                    <p class="time-profilo-numeri"><a class="nounderline"  href="/user/<?php echo($element->id); ?>/timing"><?php echo ($element->timers); ?></a></p>
                    <p class="time-profilo-numeri"><a class="nounderline"  href="/user/<?php echo($element->id); ?>/timers"><?php echo ($element->timing); ?></a></p>
                </div>
            </div>
